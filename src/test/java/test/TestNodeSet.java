...
public final class TestNodeSet {
	...
	public static void main(String[] args) throws Exception {
		...
		t.test("S03", contacts.get(1).path(), "/addressbook/contact[1]");
		t.test("S04", contacts.get(2).getValue(), "2");
		t.test("S05", contacts.get(2).path(), "/addressbook/contact[2]");
		t.test("S06", names.get(1).path(), "/addressbook/contact[1]/firstname");
		t.test("S07", names.get(2).path(), "/addressbook/contact[2]/firstname");
		t.test("S08", numbers.get(1).path(), "/addressbook/contact[1]/phonenumber[1]");
		t.test("S09", numbers.get(2).path(), "/addressbook/contact[1]/phonenumber[2]");
		t.test("S10", numbers.get(3).path(), "/addressbook/contact[2]/phonenumber[1]");
		t.test("S11", numbers.get(4).path(), "/addressbook/contact[2]/phonenumber[2]");
	}
}
